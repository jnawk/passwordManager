...
function newPassword() {
    $( ':mobile-pagecontainer' ).pagecontainer( 'change', $('#newPasswordForm'));
}

function changePassword() {
    $( ':mobile-pagecontainer' ).pagecontainer( 'change', $('#changePassword'));
}
...
function showPasswordDetails() {
    ...
    loadPasswordDetails();
    $( ':mobile-pagecontainer' ).pagecontainer( 'change', $('#passwordDetails'));
}
...
function deletePasswordConfirm() {
    ...
    $( ':mobile-pagecontainer' ).pagecontainer( 'change', $('#deletePasswordConfirm'));
}
...
function getPasswordList() {
	...
	success : function(data, testStatus, jqXHR) {
		...
		// remove existing passwords from list
